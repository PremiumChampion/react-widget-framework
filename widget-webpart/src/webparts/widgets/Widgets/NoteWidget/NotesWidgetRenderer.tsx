import { Callout, DirectionalHint, IconButton, Text, TextField } from 'office-ui-fabric-react';
import * as React from "react";
import { v4 } from 'uuid';
import styles from "./NotesWidgetStyles.module.scss";
...
export default class NotesWidgetRenderer extends React.Component<NotesWidgetRendererProps, NotesWidgetRendererState> {
    ...
    public render(): JSX.Element
    {
        return (
            ...
            <div
                className={styles["Notes_Icon"] + " WIDGET-NODRAG"}
                onClick={() =>
                {
