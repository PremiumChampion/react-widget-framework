...
export const WidgetInternalRenderer = (props: IGridItemInternalProps) =>
{
    ...
    return (
        <div className={["item", props.item.isDraggable ? props.item.draggableIndicatorClassName : "", "TS-PREVIEW"].join(" ")}>
            <div className="item-content">
                <div className="card">
                    <div className={`WIDGET-CONTENT ${ (props.item.contentDragable && props.item.isDraggable) ? "WIDGET-DRAG " : "" }`} id={props.item.id}>
                        {props.item.render()}
                    </div>
                    ...
                    {props.item.displayDragHandle && props.item.isDraggable &&
                        <div className="WIDGET-DRAG WIDGET-DRAG-HANDLE">
                ...
                {props.item.notificationCount > 0 &&
                    <div className="WIDGET-NOTIFICATION-BUBBLE">
                        <div>
